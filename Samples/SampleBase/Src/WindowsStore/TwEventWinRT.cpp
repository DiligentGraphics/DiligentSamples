...
TwEventWinRTHelper^ TwEventWinRTHelper::Create(_In_ CoreWindow^ window)
{
    auto p = ref new TwEventWinRTHelper(window);
    return static_cast<TwEventWinRTHelper^>(p);
}

TwEventWinRTHelper::TwEventWinRTHelper(_In_ CoreWindow^ window) : 
    s_PrevKeyDown(0),
    s_PrevKeyDownMod(0),
    ...
    s_WheelPos(0)
{
    window->PointerPressed +=
        ref new TypedEventHandler<CoreWindow^, PointerEventArgs^>(this, &TwEventWinRTHelper::OnPointerPressed);

    window->PointerMoved +=
        ref new TypedEventHandler<CoreWindow^, PointerEventArgs^>(this, &TwEventWinRTHelper::OnPointerMoved);

    window->PointerReleased +=
        ref new TypedEventHandler<CoreWindow^, PointerEventArgs^>(this, &TwEventWinRTHelper::OnPointerReleased);

    window->PointerExited +=
        ref new TypedEventHandler<CoreWindow^, PointerEventArgs^>(this, &TwEventWinRTHelper::OnPointerExited);

    window->KeyDown +=
        ref new TypedEventHandler<CoreWindow^, KeyEventArgs^>(this, &TwEventWinRTHelper::OnKeyDown);

    window->KeyUp +=
        ref new TypedEventHandler<CoreWindow^, KeyEventArgs^>(this, &TwEventWinRTHelper::OnKeyUp);

    window->PointerWheelChanged +=
        ref new TypedEventHandler<CoreWindow^, PointerEventArgs^>(this, &TwEventWinRTHelper::OnPointerWheelChanged);

    // There is a separate handler for mouse only relative mouse movement events.
#if (WINAPI_FAMILY != WINAPI_FAMILY_PHONE_APP)
    MouseDevice::GetForCurrentView()->MouseMoved +=
        ref new TypedEventHandler<MouseDevice^, MouseEventArgs^>(this, &TwEventWinRTHelper::OnMouseMoved);
#endif
}

void TwEventWinRTHelper::OnPointerPressed(
...
#ifdef TwEventWinRTHelper_TRACE
...
void TwEventWinRTHelper::OnPointerMoved(
    _In_ CoreWindow^ /* sender */,
    _In_ PointerEventArgs^ args
    )
{
...
void TwEventWinRTHelper::OnPointerWheelChanged(
    _In_ CoreWindow^ /* sender */,
    _In_ PointerEventArgs^ args
    )
{
...
void TwEventWinRTHelper::OnMouseMoved(
...
void TwEventWinRTHelper::OnPointerReleased(
    _In_ CoreWindow^ /* sender */,
    _In_ PointerEventArgs^ args
    )
{
...
void TwEventWinRTHelper::OnPointerExited(
    _In_ CoreWindow^ /* sender */,
    _In_ PointerEventArgs^ args
    )
{
...
void TwEventWinRTHelper::OnKeyDown(
    _In_ CoreWindow^ /* sender */,
...
void TwEventWinRTHelper::OnKeyUp(
    _In_ CoreWindow^ /* sender */,
    _In_ KeyEventArgs^ args
    )
{
...
void TwEventWinRTHelper::ShowCursor()
{
...
void TwEventWinRTHelper::HideCursor()
{
