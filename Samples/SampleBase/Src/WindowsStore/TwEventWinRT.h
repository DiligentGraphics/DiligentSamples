...
ref class TwEventWinRTHelper
{
internal:
    static TwEventWinRTHelper^ TwEventWinRTHelper::Create(_In_ Windows::UI::Core::CoreWindow^ window);

    TwEventWinRTHelper(_In_ Windows::UI::Core::CoreWindow^ window);
