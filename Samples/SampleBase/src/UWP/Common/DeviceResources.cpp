...
void DX::DeviceResources::CreateDeviceResources(SampleBase *pSample)
{
    ...
    if(m_UseD3D12)
    {
        ...
        m_pRenderDevice->QueryInterface( IID_RenderDeviceD3D12, reinterpret_cast<IObject**>( &pRenderDeviceD3D12 ) );
        ComPtr<ID3D12Device> device = pRenderDeviceD3D12->GetD3D12Device();
        pRenderDeviceD3D12->Release();
	    DX::ThrowIfFailed(
		    device.As(&m_d3d12Device)
		    );
    }
    else
    {
        ...
        m_pRenderDevice->QueryInterface( IID_RenderDeviceD3D11, reinterpret_cast<IObject**>( &pRenderDeviceD3D11 ) );
        ComPtr<ID3D11Device> device = pRenderDeviceD3D11->GetD3D11Device();
        pRenderDeviceD3D11->Release();
	    DX::ThrowIfFailed(
...
void DX::DeviceResources::CreateWindowSizeDependentResources()
{
    ...
    if(m_UseD3D12)
    {
        ISwapChainD3D12 *pSwapChainD3D12 = nullptr;
        m_pSwapChain->QueryInterface( IID_SwapChainD3D12, reinterpret_cast<IObject**>(&pSwapChainD3D12) );
        ...
        pSwapChainD3D12->Release();
    }
    else
    {
        ISwapChainD3D11 *pSwapChainD3D11 = nullptr;
        m_pSwapChain->QueryInterface( IID_SwapChainD3D11, reinterpret_cast<IObject**>(&pSwapChainD3D11) );
        IDXGISwapChain3 *pDXGISwapChain3 = nullptr;
        pSwapChainD3D11->GetDXGISwapChain()->QueryInterface( __uuidof(pDXGISwapChain3), reinterpret_cast<void**>(&pDXGISwapChain3) );
        m_swapChain.Attach( pDXGISwapChain3 );
        pSwapChainD3D11->Release();
    }
