...
ASSETS_PATH := $(PROJECT_ROOT)/build/WindowsStore/AtmosphereSample.Shared/assets
...
LOCAL_C_INCLUDES += $(PROJECT_ROOT)/assets/shaders/terrain
...
LOCAL_SRC_FILES := $(TOOLS_ROOT)/External/libtiff-4.0.3/build/Windows/obj/local/$(TARGET_ARCH_ABI)/libLibTiff.a
...
LOCAL_SRC_FILES := $(TOOLS_ROOT)/External/zlib-1.2.8/build/Windows/obj/local/$(TARGET_ARCH_ABI)/libzlib.a
...
LOCAL_SRC_FILES := $(TOOLS_ROOT)/External/lpng-1.6.17/build/Windows/obj/local/$(TARGET_ARCH_ABI)/libLibPng.a
...
LOCAL_SRC_FILES := $(TOOLS_ROOT)/External/libjpeg-9a/build/Windows/obj/local/$(TARGET_ARCH_ABI)/libLibJpeg.a
...
LOCAL_SRC_FILES := $(TOOLS_ROOT)/TextureLoader/build/Windows/obj/local/$(TARGET_ARCH_ABI)/libTextureLoader.a
