...
SamplerState g_tex2DElevationMap_sampler; // Point Clamp
...
Texture2D< float3 > g_tex2DTileDiffuse0;   // Material diffuse
Texture2D< float3 > g_tex2DTileDiffuse1;   // Material diffuse
Texture2D< float3 > g_tex2DTileDiffuse2;   // Material diffuse
Texture2D< float3 > g_tex2DTileDiffuse3;   // Material diffuse
Texture2D< float3 > g_tex2DTileDiffuse4;   // Material diffuse
SamplerState g_tex2DTileDiffuse0_sampler;   
SamplerState g_tex2DTileDiffuse1_sampler;   
SamplerState g_tex2DTileDiffuse2_sampler;   
SamplerState g_tex2DTileDiffuse3_sampler;   
SamplerState g_tex2DTileDiffuse4_sampler;   

Texture2D< float3 > g_tex2DTileNM0;   // Material NM
Texture2D< float3 > g_tex2DTileNM1;   // Material NM
Texture2D< float3 > g_tex2DTileNM2;   // Material NM
Texture2D< float3 > g_tex2DTileNM3;   // Material NM
Texture2D< float3 > g_tex2DTileNM4;   // Material NM
SamplerState g_tex2DTileNM0_sampler;   
SamplerState g_tex2DTileNM1_sampler;   
SamplerState g_tex2DTileNM2_sampler;   
SamplerState g_tex2DTileNM3_sampler;   
SamplerState g_tex2DTileNM4_sampler;   
                      ...
                      out float3 SurfaceNormalTS)
{
    ...
    float3 BaseMaterialDiffuse = g_tex2DTileDiffuse0.Sample( g_tex2DTileDiffuse0_sampler, f2TileUV.xy / g_TerrainAttribs.m_fBaseMtrlTilingScale );
    ...
    float3 BaseMaterialNormal = g_tex2DTileNM0.Sample(g_tex2DTileNM0_sampler, f2TileUV.xy / g_TerrainAttribs.m_fBaseMtrlTilingScale);
    ...
    MaterialColors[1] = MtrlWeights.x > fThresholdWeight ? g_tex2DTileDiffuse1.Sample(g_tex2DTileDiffuse1_sampler, f2TileUV.xy  / fTilingScale[1]) : float3(0.0, 0.0, 0.0);
    MaterialColors[2] = MtrlWeights.y > fThresholdWeight ? g_tex2DTileDiffuse2.Sample(g_tex2DTileDiffuse2_sampler, f2TileUV.xy  / fTilingScale[2]) : float3(0.0, 0.0, 0.0);
    MaterialColors[3] = MtrlWeights.z > fThresholdWeight ? g_tex2DTileDiffuse3.Sample(g_tex2DTileDiffuse3_sampler, f2TileUV.xy  / fTilingScale[3]) : float3(0.0, 0.0, 0.0);
    MaterialColors[4] = MtrlWeights.w > fThresholdWeight ? g_tex2DTileDiffuse4.Sample(g_tex2DTileDiffuse4_sampler, f2TileUV.xy  / fTilingScale[4]) : float3(0.0, 0.0, 0.0);

#if TEXTURING_MODE == TM_MATERIAL_MASK_NM
    MaterialNormals[1] = MtrlWeights.x > fThresholdWeight ? g_tex2DTileNM1.Sample(g_tex2DTileNM1_sampler, f2TileUV.xy  / fTilingScale[1]) : float3(0.0, 0.0, 1.0);
    MaterialNormals[2] = MtrlWeights.y > fThresholdWeight ? g_tex2DTileNM2.Sample(g_tex2DTileNM2_sampler, f2TileUV.xy  / fTilingScale[2]) : float3(0.0, 0.0, 1.0);
    MaterialNormals[3] = MtrlWeights.z > fThresholdWeight ? g_tex2DTileNM3.Sample(g_tex2DTileNM3_sampler, f2TileUV.xy  / fTilingScale[3]) : float3(0.0, 0.0, 1.0);
    MaterialNormals[4] = MtrlWeights.w > fThresholdWeight ? g_tex2DTileNM4.Sample(g_tex2DTileNM4_sampler, f2TileUV.xy  / fTilingScale[4]) : float3(0.0, 0.0, 1.0);
#endif
