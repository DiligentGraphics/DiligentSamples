    ...
    , mD3D12Sprite( new GUISprite(5, 10, 140, 50, "media/directx12.dds") )
{
    ...
    // Create textures
    {
        ...
        for (UINT i = 0; i < NUM_UNIQUE_TEXTURES; ++i) {
            ...
            InitializeTexture2D(mDevice, mCommandQueue, mAsteroidTextures[i], &textureDesc, 1, 1, 4, mAsteroids->TextureData(i));
...
void Asteroids::CreateGUIResources()
{
    ...
    InitializeTexture2D(mDevice, mCommandQueue, mFontTexture, &textureDesc, 1, 1, 1, &initialData);
