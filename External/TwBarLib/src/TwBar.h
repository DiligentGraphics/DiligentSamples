...
struct CTwBar
{
    ...
    bool                    MouseButton(ETwMouseButtonID _Button, bool _Pressed, int X, int Y);
...
protected:
    ...
    void                    RotoDraw();
    void                    RotoOnMouseMove(int X, int Y);
    void                    RotoOnLButtonDown(int X, int Y);
    void                    RotoOnLButtonUp(int X, int Y);
    void                    RotoOnMButtonDown(int X, int Y);
    void                    RotoOnMButtonUp(int X, int Y);
...
void DrawArc(int X, int Y, int _Radius, float _StartAngleDeg, float _EndAngleDeg, color32 _Color);
