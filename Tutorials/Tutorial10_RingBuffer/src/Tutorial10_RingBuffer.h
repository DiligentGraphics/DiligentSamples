...
class Tutorial10_RingBuffer : public SampleBase
{
public:
    ...
    virtual const Diligent::Char* GetSampleName()const override{return "Tutorial10: Ring Buffer";}

private:
    void UpdateRippleBuffer(float CurrTime);

    static constexpr const int RippleGridSize = 256;
    ...
    Diligent::Uint32 m_NumIndices = 0;
