...
static class Program
{
    ...
    static void Main(string[] args)
    {
        ...
        using IEngineFactory engineFactory = ParseCommandLine(args) switch
        {
            ...
            GraphicsApi.Vulkan => Native.CreateEngineFactory<IEngineFactoryVk>(),
            GraphicsApi.OpenGL => Native.CreateEngineFactory<IEngineFactoryOpenGL>(),
